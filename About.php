...
<div class="about">
    ...
    <div class="col-md-8 para left">
        <p>Diplux is Asia’s fastest growing online marketplace, offering an unparalleled shopping experience in Pakistan,
           Bangladesh, Myanmar, Sri Lanka and Nepal. Diplux hosts a wide assortment of consumer electronics, fashion and beauty
           products, alongside a rapidly growing miscellany of general merchandise. Diplux privileges the personalization and 
           security of the shoppers’ experience above all else. Excellent value-for-money, large assortment of original products,
           fast delivery and easy returns are Diplux signatures. Diplux offers not just a retail solution of optimal convenience,
            it is effecting disruptive change in the digitization of the region.
            Diplux is owned by CDC Group – the UK Government’s Development Finance Institution (DFI) focused on supporting
            and developing businesses in Africa and South Asia – as well as the Asia Pacific Internet Group (APACIG).</p>
    </div>
          <div class="col-md-4 left">
            <img src="img/LP-2_02.png">
          </div>
        <div class="col-md-12 grow">
            <h3>Our Journey</h3>
            <img src="img/LP-2_09.jpg" alt="grow">
        </div>
