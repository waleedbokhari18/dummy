...
<body><!-- navbar -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/2f71038501ff7__Know-your-Tech-LP_1000x400.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/386f5435f40e7__new_generation.jpg" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/7244bba3a913__PS4-Games.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/8410eabf8eb5__1000x400__8_.jpg" alt="Second slide">
    </div>
    </div>
  </div>
...
<!-- Heading -->
<h1 id="heading1" class="col-md-12">We are DUPLIX!</h1>
<!-- card -->
<div class="col-md-4  left">
  <div class="card" style="width: 20rem;">
    <a href="#" style="color:#1F2124">
  <img class="card-img-top" src="img/1 (1).jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Sony Hitman: The Complete First Season Steelbook Edition</h4></a>
    <p class="card-text">Key Features
Number of Players: Single and Multiplayer
Genre: Third Person Action
Platform: Playstation 4
Region 2</p>
    <a href="cart.html" class="btn btn-primary btno">ADD TO CART</a>
  </div>
</div>
</div>
<div class="col-md-4 left">
  <div class="card" style="width: 20rem;">
    <a href="fifa-18.html" style="color:#1F2124">
  <img class="card-img-top" src="img/1.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Electronic Arts FIFA 18 - Standard Edition - PlayStation 4</h4></a>
    <p class="card-text">
...
<div class="col-md-4 left">
  ...
  <div class="card-body">
    <h4 class="card-title">Ubisoft Watch Dogs - PS4-Standard Edition</h4></a>
    <p class="card-text">Key Features<br>
Genre: Action<br>
No. of Players: Single Player<br>
Platform: Playstation 4</p>
    <a href="cart.html" class="btn btn-primary btno">ADD TO CART</a>
  </div>
</div>
</div>
